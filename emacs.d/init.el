...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-ghc ghc hindent clj-refactor aggressive-indent undo-tree which-key diff-hl super-save flycheck imenu-anywhere zop-to-char company cask-mode markdown-mode smex flx-ido ido-ubiquitous cider clojure-mode rainbow-mode rainbow-delimiters move-text exec-path-from-shell easy-kill anzu paredit elisp-slime-nav expand-region pt projectile ag avy zenburn-theme pbcopy use-package))))
(custom-set-faces
